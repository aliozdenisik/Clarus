...
def test_slow_query():
    ...
    with sentry_sdk.start_transaction(op="test", name="chaos-slow-query") as txn:  # noqa: F841
        with sentry_sdk.start_span(op="rag.search", description="Simulated slow search"):
