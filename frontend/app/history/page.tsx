...
export default function HistoryPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--color-bg-app)] p-8">
        ...
        {isLoading ? (
          ...
          >
            ...
            <div className="relative mb-8">
              <div className="absolute inset-0 scale-150 rounded-full bg-[var(--color-accent-primary)] opacity-10 blur-2xl" />
              <div className="relative flex h-24 w-24 items-center justify-center rounded-2xl border border-[var(--color-border-subtle)] bg-gradient-to-br from-[var(--color-bg-surface)] to-[var(--color-bg-elevated)]">
                <BookOpen className="h-10 w-10 text-[var(--color-accent-primary)] opacity-60" />
              </div>
            </div>
                  ...
                  <GlowCard className="group relative overflow-hidden">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        className="text-[var(--color-text-muted)] opacity-0 transition-opacity group-hover:opacity-100 hover:bg-red-500/10 hover:text-red-500"
