...
ÇIKTI FORMATI (JSON):
{
    ...
    FEW_SHOT_QURAN = [
        {"role": "user", "content": """SORU: Sabır neden önemlidir?
...
OUTPUT FORMAT (JSON):
{
    ...
    FEW_SHOT_BIBLE = [
        {"role": "user", "content": """QUESTION: What does the Bible say about God's love?
...
[2] Romans 5:8 - But God commendeth his love toward us, in that, while we were yet sinners, Christ died for us."""},
    ...
    def _call_llm(self, query: str, context: str, source: str) -> dict:
        ...
        try:
            ...
            return {"answer": "Cevap üretilemedi.", "cited_references": [], "confidence": 0.0}
