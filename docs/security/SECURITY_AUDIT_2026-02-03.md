...
```
OPENROUTER_API_KEY=OPENROUTER_API_KEY_REDACTED_FROM_HISTORY
GOOGLE_CLIENT_SECRET=GOOGLE_OAUTH_SECRET_REDACTED_FROM_HISTORY
JWT_SECRET_KEY=JWT_SECRET_REDACTED_FROM_HISTORY
```
